                ...
                <div class="fixed z-40 inset-0 overflow-y-auto">
                    <div class="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        <x-splade-component is="transition" child animation="fade" after-leave="confirm.emitClose">
                            <x-splade-component is="dialog" panel class="relative bg-white dark:bg-zinc-900 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
                                <div class="sm:flex sm:items-start">
                                    <div class="text-center sm:mt-0 sm:text-left">
                                        ...
                                        <div class="mt-2" v-if="confirm.text">
                                            <p class="text-sm text-gray-500 dark:text-gray-300" v-text="confirm.text" />
                                        </div>
                                ...
                                <div class="mt-5 sm:mt-4 sm:flex">
                                    <button
                                        ...
                                        :class="{
                                            'bg-green-500 hover:bg-green-700 focus:ring-green-500': !confirm.confirmDanger,
