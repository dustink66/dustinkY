<div class="relative">
    <input
      class="block bg-white bg-opacity-70 dark:bg-zinc-900 dark:bg-opacity-70 dark:text-gray-200 w-full sm:pl-9 text-sm rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 border-gray-300"
