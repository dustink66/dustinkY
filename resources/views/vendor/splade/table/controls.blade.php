<div class="bg-opacity-80 flex flex-row sm:justify-end mb-3 px-4 sm:px-0 -mr-2 sm:-mr-3">
    ...
    <button
        ...
        type="button"
        class="order-6 sm:order-4 ml-auto mr-2 sm:mr-3 bg-white bg-opacity-50 dark:bg-zinc-900 dark:bg-opacity-50 border rounded-md shadow-sm px-2.5 sm:px-4 py-2 inline-flex justify-center text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 border-gray-300"
