...
>
    <div class="flex rounded-md shadow-sm relative mt-3">
        ...
        >
            ...
            <span>{{ trans($searchInput->label) }}</span>
        </label>
        ...
        <input
            ...
            type="text"
            class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md focus:ring-green-500 focus:border-green-500 text-sm border-gray-300"
        ...
        <div class="absolute inset-y-0 right-0 pr-3 flex items-center" >
            <button
                class="rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
