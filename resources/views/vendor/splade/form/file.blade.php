...
>
    <template #default="{!! $scope !!}">
        <label class="block">
            ...
            @else
                <a @submit.prevent
                    class="inline-block py-2 px-3 rounded-md border border-gray-300 shadow-sm bg-white hover:bg-gray-100 relative cursor-pointer font-medium text-gray-700 text-sm focus:outline-none focus:ring focus:ring-opacity-50 focus:border-green-300 focus:ring-green-200 text-center">
