    ...
    <label class="block">
        ...
        <div class="flex rounded-md border border-gray-300 shadow-sm">
            ...
            <input {{ $attributes->except(['v-if', 'v-show', 'v-for', 'class'])->class([
                'block bg-white bg-opacity-50 w-full border-0 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed dark:bg-zinc-700 dark:bg-opacity-80 dark:border-zinc-400 dark:focus:border-green-500 dark:focus:ring-green-500 dark:focus:ring-opacity-50 dark:text-gray-200',
