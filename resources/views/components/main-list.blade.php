        ...
        <article class="relative isolate flex flex-col gap-4 lg:flex-row mx-auto px-4">
            ...
            <div class="flex-grow">
                ...
                <div class="group relative pt-6">
                    ...
                    <p class="mt-5 @if($item->image) lg:h-20 @endif text-base leading-6 text-gray-700 tracking-wider {{ $FONT_FAMILY }} dark:text-gray-300 line-clamp-3 bg-gray-300 bg-opacity-50 dark:bg-zinc-700 dark:bg-opacity-50 rounded-lg px-2 py-1">{{ $item->meta_description }}</p>
                </div>
                <div class="mt-5 flex border-t border-gray-900/5 dark:border-gray-100/5 pt-5 {{ $FONT_FAMILY }} justify-between">
            ...
            <article class="relative isolate flex flex-col gap-4 lg:flex-row mx-auto px-4">
                <div class="flex-grow">
                    ...
                    <div class="group relative pt-6">
                        ...
                        <p class="mt-5 @if($item->image && mb_strlen($item->meta_description, 'utf-8') < 55) lg:h-20 @endif text-base leading-6 text-gray-700 tracking-wider {{ $FONT_FAMILY }} dark:text-gray-300 line-clamp-3 bg-gray-300 bg-opacity-50 dark:bg-zinc-700 dark:bg-opacity-75 rounded-lg px-2 py-1">{{ $item->meta_description }}</p>
                    </div>
